...
led_font_dict = {
  ...
  font_led_chi  :  {"spacing" : 20, "padding" : -1 , "height_plus" : 13 , "required_height_plus" : 3  , "unneeded_width" : 4 , "unneeded_padding" : 15},
...
color_choices = [
  ...
  {'name': "Conventional Orange", 'value': "orange"}, {'name': "Conv. Orange Inverted", 'value': "iorange"},
...
led_sc_choices = [
  ...
  {'name': "Caps (Blocky)", 'value': "fat"}
]
led_sc_fonts = {
  'regular': font_led2,
  'bold': font_led2_bold,
  'serif': font_led2_serif,
  'modern': font_led2_modern,
  'caps': font_led2_caps,
  'fat': font_led2_fat
}
...
@bs.command(name="led_segment_7", description="Generates a fake 7-segment LED screen.",
           ...
           description="Optionally overwrites the text color. Use a 6-digit hexadecimal code.",
           type=str, required=False)])
async def led_segment_7(ctx, text, font, thickness="2", italics="", color="red", alignment="center", background_color=None, text_color=None):
  background_color = ("#" + (background_color.replace("#", "") if background_color else db["led_colors"][color]["bg"]) +
    ("00" if not background_color and color in ["tblack", "tdark", "tlight", "twhite"] else "FF"))
  text_color = "#" + (text_color.replace("#", "") if text_color else db["led_colors"][color]["fg"]) + "FF"
...
@bs.command(name="led_segment_14", description="Generates a fake 14-segment LED screen.",
           ...
           description="Optionally overwrites the text color. Use a 6-digit hexadecimal code.",
           type=str, required=False)])
async def led_segment_14(ctx, text, font, thickness="2", italics="", color="red", alignment="center", background_color=None, text_color=None):
  background_color = ("#" + (background_color.replace("#", "") if background_color else db["led_colors"][color]["bg"]) +
    ("00" if not background_color and color in ["tblack", "tdark", "tlight", "twhite"] else "FF"))
  text_color = "#" + (text_color.replace("#", "") if text_color else db["led_colors"][color]["fg"]) + "FF"
