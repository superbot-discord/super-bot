...
async def emoji(ctx,*,newsec):
  ...
  newsec=newsec.lower()
  newsec=newsec.replace("wc","$_wc:")
  newsec=newsec.replace("ng","$_ng:")
  newsec=newsec.replace("ok","$_ok:")
  newsec=newsec.replace("up!","$_up!:")
  newsec=newsec.replace("cool","$_cool:")
  newsec=newsec.replace("new","$_new:")
  newsec=newsec.replace("free","$_free:")
  newsec=newsec.replace("tm","$_tm:")
  newsec=newsec.replace("id","$_id:")
  newsec=newsec.replace("vs","$_vs:")
  newsec=newsec.replace("sos","$_sos:")
  newsec=newsec.replace("(c)","$_copyright:")
  newsec=newsec.replace("(r)","$_registered:")
  newsec=newsec.replace("$_wc",":wc")
  newsec=newsec.replace("$_ng",":ng")
  newsec=newsec.replace("$_ok",":ok")
  newsec=newsec.replace("$_up!",":up")
  newsec=newsec.replace("$_cool",":cool")
  newsec=newsec.replace("$_new",":new")
  newsec=newsec.replace("$_free",":free")
  newsec=newsec.replace("$_tm",":tm")
  newsec=newsec.replace("$_id",":id")
  newsec=newsec.replace("$_vs",":vs")
  newsec=newsec.replace("$_sos",":sos")
  newsec=newsec.replace("$_copyright",":copyright")
  newsec=newsec.replace("$_registered",":registered")
